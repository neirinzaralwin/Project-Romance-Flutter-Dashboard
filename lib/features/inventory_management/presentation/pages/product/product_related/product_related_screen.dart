  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(5), color: AppColor.warmWhite),
      width: 300,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Related",
                style: headlineSmall.copyWith(color: AppColor.greenDark)),
            const SizedBox(height: 30),
            Row(
              children: [
                Icon(Icons.circle,
                    size: labelLarge.fontSize, color: AppColor.blueColor),
            ...
            Row(
              children: [
                FaIcon(FontAwesomeIcons.one,
                    size: labelLarge.fontSize, color: AppColor.greenDark),
                const SizedBox(width: 10),
                FilledButton(
