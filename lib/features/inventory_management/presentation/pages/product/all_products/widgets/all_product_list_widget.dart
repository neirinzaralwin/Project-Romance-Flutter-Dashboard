          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  flex: 5,
                  child: Text(product.name ?? '', textAlign: TextAlign.start, maxLines: 2, overflow: TextOverflow.ellipsis, style: labelLarge),
                ),
                const SizedBox(width: 10),
                Expanded(
                    flex: 2,
                    child: Text("${product.price.comma()} ${AppConst.currencyUnit}",
                        textAlign: TextAlign.start, maxLines: 2, overflow: TextOverflow.ellipsis, style: labelLarge)),
                const SizedBox(width: 10),
                Expanded(flex: 2, child: Text("10/200", textAlign: TextAlign.start, maxLines: 2, overflow: TextOverflow.ellipsis, style: labelLarge)),
