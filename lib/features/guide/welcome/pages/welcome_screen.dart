    ...
    return Scaffold(
      ...
      children: [
        ...
        Positioned.fill(
          ...
          children: [
            Text("Welcome to", style: headlineMedium.copyWith(color: AppColor.white)),
            const SizedBox(height: 5),
            Text("Project Romance", style: headlineLarge.copyWith(color: AppColor.white, fontWeight: FontWeight.bold)),
